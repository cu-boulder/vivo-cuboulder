    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            $('.facet-view-simple').facetview({
                search_url: '/es/fispubs-setup-news/publication/_search',
                page_size: 20,
		    ...
		    {'field': 'altmetric.score', 'display': 'Altmetric Range', "type" : "range", "range" : [{"to" : 0.001, "display" : "0 or no value"}, {"from" : 0.001, "to" :  100, "display" : "1 - 99"}, {"from" : 100, "to" : 500, "display" : "100 - 499"}, {"from" : 500, "display" : "500+"}], 'sort':'desc', "size" : 25},
		    {'field': 'altmetric.posts.news.author.name.keyword', 'display': 'Altmetric News Organization'},
                ],
                search_sortby: [
                    {'display':'Title','field':'name.keyword'},
                    {'display':'Date','field':'publicationDate'},
                    {'display':'Altmetric Attention','field':'altmetric.score'}
                ],
