            ...
            <article class="property" role="article">
                ...
                <ul class="property-list" role="list" id="${property.localName}-${rangeClass}-List">
                    ...
                    <#if property.type == "data">
                        <#if property.localName == "url" || property.localName == "serviceFeeUrl">
                            <#list property.statements as statement>
                                <li role="listitem"><a href="${statement.value}">${statement.value}</a></li>
                            </#list>
                        <#elseif property.localName == "email">
                            <#list property.statements as statement>
                                <li role="listitem"><a href="mailto:${statement.value}">${statement.value}</a></li>
                            </#list>
                        <#else>
